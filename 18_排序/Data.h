...
public:
    ...
    void Print();
private:
    static const int m_nDefaultSize;
...
template<typename Type> 
const int DataList<Type>::m_nDefaultSize = 10;

template<typename Type> 
DataList<Type>::DataList(Type *data, int size) : m_nMaxSize(size > m_nDefaultSize ? size : m_nDefaultSize), m_ncurrentsize(0)
{
...
template<typename Type> 
bool DataList<Type>::Insert(Type item)
{
